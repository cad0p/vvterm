...
//  iotest
//
//  Session 1.9 — the blocking POST /webapi/headless/login and its
//  request/response types. Ports the shape of Teleport's
...
//  That survival is the device-only unknown this session de-risks.
//
...
/// device-only unknown this session de-risks.
///
/// - Parameters:
