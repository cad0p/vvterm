...
//
//  What's NOT compared:
//    - A Swift-generated signature (the Swift signer uses its own software or
//      SEP key, not the generator's key). The generator's deterministic
//      signature is injected into the attObj comparison above, and the signer
...
final class FixtureTests: XCTestCase {
    ...
    func testAttestationObject_matchesGoFixture() throws {
        ...
        // Load the Go-generated signature (deterministic — fixed key +
        // RFC 6979).
